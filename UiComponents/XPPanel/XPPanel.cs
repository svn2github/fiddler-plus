...
using XPPanelControl.Designers;

namespace XPPanelControl {
	...
	///			<description>Set the style of the <c>XPPanel</c> - <see cref="XPPanelControl.XPPanelStyle.Custom"/> or 
	///			<see cref="XPPanelControl.XPPanelStyle.WindowsXP"/></description>
	///		</item>
	///	</list>
	///	</para>
	///	<para>
	...
	public class XPPanel : System.Windows.Forms.Panel {
		...
		/// <see cref="XPPanelControl.XPPanelStyle.WindowsXP"/>
		/// </summary>
			...
			get {
				lock(typeof(XPPanel)) {
					if (xpStyleExpandGlyphs == null) {
						...
						try {
                            xpStyleExpandGlyphs.ImageSet = new ImageSet(LoadBitmap("DataResources.RunAdmin.Controls.XPPanel.xp.style.glyphs.png"), 4);
			...
			get {
				lock(typeof(XPPanel)) {
					if (xpStyleCollapseGlyphs == null) {
						...
						try {
                            xpStyleCollapseGlyphs.ImageSet = new ImageSet(LoadBitmap("DataResources.RunAdmin.Controls.XPPanel.xp.style.glyphs.png"), 4);
		...
		/// </summary>
		/// <remarks>
		/// <see cref="XPPanelControl.XPPanelStyle.Custom"/> uses all user-defined settings, while 
		/// <see cref="XPPanelControl.XPPanelStyle.WindowsXP"/> provides overrides to certain properties
		/// to provide a <c>WindowsXP</c> look and feel.
		/// <para>
		/// Currently, <see cref="XPPanelControl.XPPanelStyle.WindowsXP"/>, overrides user-specified values
