...
namespace XPPanelControl {
	...
	public class TextLayoutPanel : Panel {
		...
		/// </summary>
		/// <remarks>
		/// When the <see cref="BackgroundStyle"/> is <see cref="XPPanelControl.BackgroundStyle.Solid"/>
		/// the brush is created with the <see cref="Control.BackColor"/> value, otherwise
		/// if <see cref="BackgroundStyle"/> is <see cref="XPPanelControl.BackgroundStyle.Gradient"/>
		/// we use the <see cref="PanelGradient"/> color values.
		/// 
		/// In the case of <see cref="XPPanelControl.BackgroundStyle.Transparent"/> the result is <b>undefined</b>
		/// </remarks>
	...
	public class TextElement : ITextElement {
		...
		/// <summary>
		/// Get the <see cref="XPPanelControl.TextStyle.SpacingAdjustment"/>
		/// associated with the <c>ITextElement</c>
		/// </summary>
		/// <remarks>
		/// If no <see cref="TextStyle"/> is associated with this <c>TextElement</c> this 
		...
		/// <summary>
		/// Get/Set the <c>ImageIndex</c> that maps to the <see cref="XPPanelControl.TextStyle.ImageSet"/>
