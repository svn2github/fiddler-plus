...
namespace UoFiddler
{
    public partial class UoFiddler : Form
    {
        ...
        public static Telnet.Client Telnet { get; private set; }
...
return;
        ...
        private void ExternTool_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            if (toolinfo >= 0)
            {
                if (arginfo >= -1)
                {
                    ...
                    {
                        MessageBox.Show(ex.Message, "Ошибка запуска приложения",
        ...
        private void OnClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                DialogResult result =
                        MessageBox.Show(String.Format("Вы уверены, что хотите выйти?\r\n{0}", files),
                        "Несохраненные измения",
        ...
        private TabPage TabFromTag(int tag)
        {
            switch (tag)
            {
                ...
                case 2: return AnimData;
                case 3: return Items;
                case 4: return TileDatas;
                case 5: return LandTiles;
                case 6: return Texture;
                case 7: return Multis;
                case 8: return Gumps;
                case 9: return Sounds;
                case 10: return Light;
                case 11: return Hue;
                case 12: return fonts;
                case 13: return Cliloc;
                case 14: return speech;
                case 15: return Skills;
                case 16: return SkillGrp;
                case 17: return map;
                case 18: return RadarCol;
                case 19: return multimap;
        ...
        private ToolStripMenuItem MenuFromTag(int tag)
        {
            switch (tag)
            {
                ...
                case 1: return ToggleViewAnimations;
                case 2: return ToggleViewAnimData;
                case 3: return ToggleViewItems;
                case 4: return ToggleViewTileData;
                case 5: return ToggleViewLandTiles;
                case 6: return ToggleViewTexture;
                case 7: return ToggleViewMulti;
                case 8: return ToggleViewGumps;
                case 9: return ToggleViewSounds;
                case 10: return ToggleViewLight;
                case 11: return ToggleViewHue;
                case 12: return ToggleViewFonts;
                case 13: return ToggleViewCliloc;
                case 14: return ToggleViewSpeech;
                case 15: return ToggleViewSkills;
                case 16: return ToggleViewSkillGrp;
                case 17: return ToggleViewMap;
                case 18: return ToggleViewRadarColor;
                case 19: return ToggleViewMultiMap;
                case 20: return ToggleViewDress;
