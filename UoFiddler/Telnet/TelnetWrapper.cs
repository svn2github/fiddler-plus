/*
 * Ported from Matthias L. Jugel's and Marcus MeiЯner's JTA.
 *
 * (c) Matthias L. Jugel, Marcus MeiЯner 1996-2002. All Rights Reserved.
	...
	public class TelnetWrapper : TelnetProtocolHandler
	{
		...
		public void Connect(string host, int port)
		{
			try
			{
                ...
                IPHostEntry ipHostInfo = System.Net.Dns.GetHostEntry(host);
                ...
                if (ipAddress == null)
                    throw new Exception(String.Format("Не удалось обнаружить узел '{0}'", host));
		...
		private void ReceiveCallback(IAsyncResult ar) 
		{
			try 
			{
				...
				if (bytesRead > 0) 
				{
					...
					DataAvailable(this,
                        new DataAvailableEventArgs(encoding.GetString(state.Buffer, 0, bytesRead)));
