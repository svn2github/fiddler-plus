...
namespace Ultima
{
    public sealed class Map
    {
        ...
        /// <summary>
        /// Return uoquint.ru Dangeon Map class (map0.mul)
        /// </summary>
        public static Map Dangeon
        {
			get { return m_Felucca ?? (m_Felucca = new Map(0, 0, 6144, 4096)); }
			set { m_Felucca = value; }
        }
        //private static Map m_Dangeon = null;

        /// <summary>
        /// Return uoquint.ru Sosaria Map class (map1.mul)
        /// </summary>
        public static Map Sosaria
        {
			get { return m_Trammel ?? (m_Trammel = new Map(1, 1, 12288, 8192)); }
			set { m_Trammel = value; }
        }
        //private static Map m_Sosaria = null;


		/// <summary>
		/// Return osi pre-Alpha Britania Map class (map0.mul)
		/// </summary>
		public static Map Britania
		{
			get { return m_Felucca ?? (m_Felucca = new Map(0, 0, 1024, 1024)); }
			set { m_Felucca = value; }
		}
		//private static Map m_Britania = null;

        /// <summary>
        /// Return osi Felucca Map class (map0.mul)
        /// </summary>
        ...
        private static Map m_Felucca = null;

        /// <summary>
        /// Return osi Trammel Map class (map1.mul)
        /// </summary>
        public static Map Trammel
        {
            get { return m_Trammel ?? (m_Trammel = new Map(0, 1, 6144, 4096)); }
            set { m_Trammel = value; }
        }
        private static Map m_Trammel = null;

        /// <summary>
        /// Return osi Ilshenar Map class (map2.mul)
        /// </summary>
        public static Map Ilshenar
        {
            get { return m_Ilshenar ?? (m_Ilshenar = new Map(2, 2, 2304, 1600)); }
        }
        private static Map m_Ilshenar = null;

        /// <summary>
        /// Return osi Malas Map class (map3.mul)
        /// </summary>
        public static Map Malas
        {
            get { return m_Malas ?? (m_Malas = new Map(3, 3, 2560, 2048)); }
        }
        private static Map m_Malas = null;

        /// <summary>
        /// Return osi Tokuno Map class (map4.mul)
        /// </summary>
        public static Map Tokuno
        {
            get { return m_Tokuno ?? (m_Tokuno = new Map(4, 4, 1448, 1448)); }
        }
        private static Map m_Tokuno = null;

        /// <summary>
        /// Return osi TerMur Map class (map5.mul)
        /// </summary>
        public static Map TerMur
        {
            get { return m_TerMur ?? (m_TerMur = new Map(5, 5, 1280, 4096)); }
        }
        private static Map m_TerMur = null;

        /// <summary>
        /// Return Custom Map class (map?.mul)
        /// </summary>
        ...
        private static Map m_Custom = null;
