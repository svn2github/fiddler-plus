...
namespace FiddlerControls.RegionEditor.MapViewer
{
	...
	public class MapViewInfo
	{
		...
		private void Calculate()
		{
			...
			switch ( m_Map )
			{
                case Maps.Dungeon:  m_MapSize = MapSizes.Dungeon;   break;
				case Maps.Sosaria:  m_MapSize = MapSizes.Sosaria;   break;
				//case Maps.Felucca:  m_MapSize = MapSizes.FeluccaML; break;
				//case Maps.Trammel:  m_MapSize = MapSizes.TrammelML; break;
				case Maps.Ilshenar: m_MapSize = MapSizes.Ilshenar;  break;
				case Maps.Malas:    m_MapSize = MapSizes.Malas;     break;
				case Maps.Tokuno:   m_MapSize = MapSizes.Tokuno;    break;
                case Maps.TerMur:   m_MapSize = MapSizes.TerMur;    break;
				default: throw new Exception( string.Format( "Map not supported: {0}.", m_Map.ToString() ) );
			}
